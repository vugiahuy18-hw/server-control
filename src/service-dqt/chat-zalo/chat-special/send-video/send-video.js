...
const VIDEO_TYPES = {
  girl: {
    variants: {
      default: { source: "vdgirl.txt", ttl: 600000 },
      sexy: { source: "vdsexy.txt", ttl: 600000, type: "Sexy" },
    },
  },
  sexy: {
    variants: {
      default: { source: "vdsexy.txt", ttl: 600000 },
    },
  },
  anime: {
    variants: {
      default: { source: "vdanime.txt", ttl: 600000 },
    },
  },
  cosplay: {
    variants: {
      default: { source: "vdcos.txt", ttl: 600000 },
    },
  },
  boy: {
    variants: {
      default: { api: "https://api.hungdev.id.vn/randoms/video-boy?apikey=0ebdd6ae9a", ttl: 300000 },
    },
  },
  sex: {
    variants: {
      default: { source: "vdsex.txt", ttl: 600000 },
    },
  },
};
